...
Process:
1. Search `knowledge_base/mastering/{loudness,dynamics,streaming}` (Grep/Glob) for relevant targets and technique entries. If the genre isn't covered yet, reason from general mastering standards and say so.
