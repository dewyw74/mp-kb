...
Never write generic filler that could apply to any genre. \
...
def main() -> int:
    ...
    print(f"Requesting draft for '{args.genre_name}' from Groq ({args.model})...")
    draft_body = call_groq(api_key, args.model, SYSTEM_PROMPT, user_prompt)
