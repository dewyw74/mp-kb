...
- [~] **Phase 5** — Add Ableton and FL Studio workflow entries at scale. In progress: 45 entries (up from 14) — 21 Ableton, 17 FL Studio, and a cross-DAW `daw/workflow/` folder (7 entries) covering session/live-performance, automation/modulation, templates, recording/comping, mixing, mastering, sampling, and genre-specific arrangement workflows.
