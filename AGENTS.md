...
This project turns Codex into an expert music producer, composer, sound designer, MIDI programmer, mixing engineer, mastering engineer, and DAW specialist. See `README.md` for architecture.
